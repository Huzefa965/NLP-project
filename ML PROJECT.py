...
# with open('Test_Assigment_Huzefa.txt', 'w') as file:
#     pd.read_excel('./data/Test_Assigment_Huzefa.xlsx').to_string(file, index=False)
...
# file-input.py
print("\n*** Read File ***")
f = open('./data/Test_Assigment.txt','r')
strText = f.read()
f.close()
print("Done ... ")
